...
# kubectl delete pod criteo-sample-kubernetes-chief-0 criteo-sample-kubernetes-ps-0 criteo-sample-kubernetes-worker-0 criteo-sample-kubernetes-worker-1 --now
# kubectl delete pod
# kubectl delete service criteo-sample-kubernetes-chief-0 criteo-sample-kubernetes-ps-0 criteo-sample-kubernetes-worker-0 criteo-sample-kubernetes-worker-1 --now
